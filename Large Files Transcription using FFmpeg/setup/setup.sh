...
wget https://assets.s3.us-east-1.amazonaws.com/uploads/learn/openai-whisper/cosmo_feedback.mp4 -O 'resources/cosmo_feedback.mp4'
wget 'https://assets.s3.us-east-1.amazonaws.com/uploads/learn/openai-whisper/conversation_practice+.mp4' -O 'resources/conversation_practice.mp4'
wget https://assets.s3.us-east-1.amazonaws.com/uploads/learn/openai-whisper/beyond.mp4 -O 'resources/beyond.mp4'
wget https://assets.s3.us-east-1.amazonaws.com/uploads/learn/openai-whisper/ai_interviewer_sales.mp4 -O 'resources/ai_interviewer_sales.mp4'
